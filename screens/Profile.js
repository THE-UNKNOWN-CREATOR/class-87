...
export default class Profile extends Component {
  ...
  { 
    ...
    .on("value", function (snapshot) 
      { 
        theme = snapshot.val().current_theme; name = `${snapshot.val().first_name} ${snapshot.val().last_name}`;
  ...
  toggleSwitch(){
    ...
    this.setState({isEnabled: !prevState, light_theme: prevState});
  }
        ...
        <View style={styles.container}>
          <SafeAreaView style={styles.droidSafeArea} >
            <View style={styles.appTitle}>
              ...
              <Image style={styles.appIcon} source={{uri:this.state.profile_image}}></Image>
            </View>
